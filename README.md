...
## Features
Lightweight: Minimal resource usage for fast and responsive proxying. <br/>
Caching: Supports caching of web content to speed up subsequent requests. <br/>
Traffic Management: Can manage and filter HTTP traffic efficiently. <br/>
